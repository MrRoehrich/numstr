...
void calcCoeff(sData* data,double dx, double dy, double vn, double ue, double vs, double uw, double& an, double& ae, double& as, double& aw, double& ap, double& apTilde);
