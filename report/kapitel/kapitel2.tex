...
\end{table}
\FloatBarrier
Zunächst wird die Zentrale-Differenzen-Methode verwendet, danach die Upwind-Methode. Bei der ersten Variante sollte sich der mittlere Wert nicht ändern, da er zu gleichen Teilen vom oberen, unteren, rechten und linken Wert abhängt, die alle den gleichen numerischen Wert haben. Bei der Upwind-Methode sollte sich der Wert der linken Zelle durchsetzen, da dies die Zelle stromauf der konvektiven Strömung ist. Die Ergebnisse zeigen genau dieses Resultat:
\FloatBarrier
