...
\tilde{a}_{i,j+\frac{1}{2}}\cdot v_{i,j+\frac{1}{2}}^{k}= \notag \\
& a_{i+1,j+\frac{1}{2}}\cdot v_{i+1,j+\frac{1}{2}}^{k}+a_{i-1,j+\frac{1}{2}}\cdot v_{i-1,j+\frac{1}{2}}^{k}+a_{i,j+\frac{3}{2}}\cdot v_{i,j+\frac{3}{2}}^{k}+a_{i,j-\frac{1}{2}}\cdot v_{i,j-\frac{1}{2}1}^{k}+ \notag \\
